...
class Clock(SampleBase):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("--colour_secondary", help="The 2nd text colourif --cycle-colours and --enable-arrow-keys are False, formatted as 6-digit hexadecimal string (e.g. '7f4800')", default='7f4800')
        self.parser.add_argument("--scriobh_as_gaeilge", help="Set as true to print date in Irish langauge", default=False)
